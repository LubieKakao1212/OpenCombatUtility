...
//        this(id, playerInventory, SlotProvider.dummy(ammoSlotCount + 1), ScreenHandlerContext.EMPTY, new ArrayPropertyDelegate(BlockEntityModularFrame.screenPropertyCount));
//    }
//
